...
- 🎯 Entry points to execute your program using `python -m <trivia>` or `$ trivia` with basic CLI argument parsing.
...
Awesome trivia created by rochacbruno
...
```py
from trivia import BaseClass
from trivia import base_function
